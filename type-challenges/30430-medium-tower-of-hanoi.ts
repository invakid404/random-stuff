...
type Predecessor = [never, 0, 1, 2, 3, 4, 5, 6, 7, 8];
...
type Hanoi<
  ...
  To = 'B',
  Intermediate = 'C',
> = N extends 0 ? [] : HanoiHelper<N, From, To, Intermediate>;

type HanoiHelper<N extends number, From, To, Intermediate> = N extends 1
  ? [[From, To]]
  : [
      ...HanoiHelper<Predecessor[N], From, Intermediate, To>,
      ...HanoiHelper<1, From, To, Intermediate>,
      ...HanoiHelper<Predecessor[N], Intermediate, To, From>,
    ];
