...
type NumberToArray<
  T extends number,
  A extends unknown[] = [],
> = A['length'] extends T ? A : NumberToArray<T, [...A, unknown]>;

type TwoSumHelper<T extends number[], U extends unknown[]> = T extends [
  infer Head extends number,
  ...infer Rest extends number[],
]
  ? U extends [...NumberToArray<Head>, ...infer R]
...
type TwoSum<T extends number[], U extends number> = TwoSumHelper<
  T,
  NumberToArray<U>
>;
