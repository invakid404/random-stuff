...
type CurriedReturnType<Args extends readonly any[], Return> = Args extends []
  ? Return
  : Args extends [infer First, ...infer Rest]
  ? (arg: First) => CurriedReturnType<Rest, Return>
  : never;

type CurriedFunction<Function> = Function extends (
  ...args: infer Args
) => infer Return
  ? CurriedReturnType<Args, Return>
  : never;

declare function Currying<Function>(fn: Function): CurriedFunction<Function>;
